    ...
    return (
      <NavMobileContainer>
        <MobileTopNav>
          ...
          <AnchorButton style={{ alignSelf: 'center', marginRight: '1em' }} href="https://www.meetup.com/GDG-Cloud-Miami/" small="true" target="_blank" rel="noopener noreferrer">Register now</AnchorButton>
        </MobileTopNav>
